...
def main():
    ...
    parser.add_argument("--configuration", choices=("dynamic", "static"), default="dynamic",
    ...
    hardware = {
        ...
        "mapper_banks": 2 if args.configuration == "dynamic" else 1,
    ...
    metadata = {
        ...
        "logical_storage_bits": {
            ...
            "front_rewrite_registers": args.engines * args.vpifos * (v + 4) if args.configuration == "dynamic" else 0,
    ...
    try:
        ...
        if reuse_build is not None and reuse_build != build:
            ...
            command = (f'runMain rio.GeneratePifoMesh "{rtl}" {args.engines} '
                       ...
                       f'{args.pifo_backend} {args.configuration}')
