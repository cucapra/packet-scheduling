...
if {$mode eq "estimate-only"} {
  set_param synth.elaboration.rodinMoreOptions {rename rt::check_resource rt::check_resource_device; proc rt::check_resource {args} {puts "RIO_ESTIMATION_ONLY_RESOURCE_CHECK_SKIPPED args=$args"; return 1}}
}
