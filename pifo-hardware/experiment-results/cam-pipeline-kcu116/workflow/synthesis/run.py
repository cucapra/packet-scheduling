...
def main():
    ...
    parser.add_argument("--component", choices=("rio", "pifo"), default="rio")
    parser.add_argument("--configuration", choices=("replay", "static"), default="replay",
    ...
    if args.component == "pifo":
        hardware.update(instances=1, budget_instances=args.engines, enabled_push_ports=1, push2_valid=0)
    ...
    if args.component == "pifo":
        ...
        metadata["hardware"].update(instances=1, budget_instances=args.engines, enabled_push_ports=1, push2_valid=0)
        metadata["logical_storage_bits"] = {"sorted_entry_registers": args.entries_per_pe * (v + args.priority_bits + token_bits)}
    if reuse_build is not None:
