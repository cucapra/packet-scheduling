...
PANELS = [{'title': 'RR → SP',
  'start': 240,
  'markers': [(0, '#1f77b4', '-', 'start'), (28, '#ff7f0e', '--', 'commit accepted'),
              (1235, '#9467bd', ':', 'old tree drained'),
              (8224, '#2ca02c', '-.', 'finish: double-buffer cleanup done')],
  'notes': 'start=240  commit accepted=268  drain=1475  finish=8464\n'
           'config=28 inst / 28 cycles to acceptance; ≤1 instruction accepted/cycle'}]
