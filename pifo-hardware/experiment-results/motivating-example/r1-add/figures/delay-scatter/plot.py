...
PANELS = [{'title': 'R1: add Spotify arm',
  ...
  'markers': [(0, '#1f77b4', '-', 'start'), (13, '#ff7f0e', '--', 'commit accepted'),
              ...
              (272, '#2ca02c', '-.', 'finish: double-buffer cleanup done')],
  'notes': 'start=2000  commit accepted=2013  drain=2015  finish=2272\n'
           'config=4 inst / 13 cycles to acceptance; ≤1 instruction accepted/cycle'}]
