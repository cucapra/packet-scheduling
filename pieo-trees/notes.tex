...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item Suppose $\pop(q_1, g)$ is defined. 
            ...
            \end{align*}
            Since our choice of $g$ was arbitrary, notice \Cref{eq:popsim} holds for all $g \in \mathcal F$.
            ...
            At last, \Cref{lem:pieotree_eq} yields $\overline{f}(q_1^\prime) = q_2^\prime$. \todo{this logic is wrong!}
