...
To the best of our knowledge, no prior work on PIFO trees says how to move a running scheduler from one configuration to another without disturbing the traffic that the old one has already buffered.
%
...
\(\csem{\Add}\)'s step case is more involved.
