...
Our hardware's goal is to apply any of the six Rio policy edits (\cref{sec:delta-grammar}) atomically
at some time $t$:
the unmodified policy applies to all packets before $t$ and the updated policy applies to all packets after $t$.
...
\xxx[as]{The paragraph below perhaps belongs somewhere else now, because it is not about atomicity. Probably in the ISA section?}
