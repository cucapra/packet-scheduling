...
\Cref{fig:hardware} shows both mechanisms on top of a standard PIFO tree.

\begin{figure}
  \centering
  \includegraphics[width=0.8\columnwidth]{pifo_hardware.pdf}
  \caption{Rio PIFO Hardware. Adding transactional commit and support for $\Designate$ on top of PIFO implementations.}
  \label{fig:hardware}
\end{figure}
