...
Logic is nearly free and stays flat across a thirty-two-fold range in flow count; memory is where the additions are paid for, and it grows with that range.
The reason is the second table bank of \cref{sec:hw-commit}: making an update atomic means holding a second copy of what the update rewrites.
