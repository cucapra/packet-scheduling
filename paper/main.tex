...
\Designate{} and \Undesignate{} do disturb entries, inserting and dropping a node whose \pifo is not empty, and they are argued on the \pop{} sequence instead, which is why the theorem is stated on the flush sequence rather than on \pifo contents.
\cref{sec:per-form} proves it form by form.
