...
Our thesis is that the interval during which a scheduler is being reprogrammed is itself a scheduling policy, since packets keep arriving and leaving while it lasts. 
...
Rio's language is a grammar of atomic policy edits, each one a change the hardware can install in a single instant.
