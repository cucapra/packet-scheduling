...
The guard of \cref{sec:sequences} gates PIFO reclamation: \texttt{v}'s PIFOs, and those of everything beneath it, may be released only once the subtree is empty, and a second transaction is guarded on the same emptiness predicate.
