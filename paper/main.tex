...
The implementation consists of 750 lines of Scala.
...
Only Rio leaves it alone (\cref{tab:eval-motivating}): its peak delay is within a cycle of what \textsf{zoom} sees under a transition that never touches its subtree, where the other two cost it an order of magnitude more and neither recovers when its interval ends.
