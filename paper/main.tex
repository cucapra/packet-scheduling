...
\zz is the \emph{scheduling transaction},
\[
...
\cref{sec:per-form} proves the theorem form by form, and \cref{sec:check-designate,sec:check-undesignate} carry the two \pop{}-sequence arguments.
