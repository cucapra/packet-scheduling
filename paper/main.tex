...
It descends through the slots at which \(p_1\) and \(p_2\) already agree and installs the difference at the deepest slot it reaches, so a change confined to one subtree leaves every other part of the tree scheduling its own traffic untouched.
