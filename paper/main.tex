...
While walking downward, it replaces that node's \zz by \(\mathtt{extend}(\mathit{z},\mathtt{flows}(\mathit{arm}),i)\), sending the new flows one step further toward \(\pi\).
