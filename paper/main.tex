...
So the state of the art~\cite{vPIFO} stops the world: it drops or recirculates the buffered packets, recompiles, and reinstalls.
...
A transition from any running policy to any requested policy is always available, and many admit transitions a realization confined precisely to the part of the tree that actually changes.
